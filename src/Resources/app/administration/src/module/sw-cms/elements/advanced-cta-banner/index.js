...
Shopware.Service("cmsService").registerCmsElement({
  ...
  name: "advanced-cta-banner",
  label: "sw-cms.elements.advanced-cta-banner.title",
  component: "sw-cms-el-advanced-cta-banner",
  configComponent: "sw-cms-el-config-advanced-cta-banner",
