...
import template from "./sw-cms-el-config-advanced-cta-banner.html.twig";
import "./index.scss";

Component.register("sw-cms-el-config-advanced-cta-banner", {
  template,
  ...
  data() {
    return {
      ...
      snippetPrefix: "sw-cms.elements.advanced-cta-banner.",
    };
  },
