...
namespace GISL\AdvancedCallToActionBanner\Content;
...
class GISLAdvancedCtaBannerTypeDataResolver extends AbstractCmsElementResolver
{
    public function getType(): string
    {
        return 'advanced-cta-banner';
    }
    ...
    {
        $config = $slot->getFieldConfig();
        $ctaBanner = new GISLAdvancedCtaBannerStruct();
